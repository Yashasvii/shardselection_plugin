...
public final class Sushi extends AbstractResourceSelection implements SushiInterface {
     ...
     * @throws IllegalArgumentException if <code>rankThreshold</code> is less than or equal to zero.
     * @see #rankThreshold
     */
     ...
     * @throws IllegalArgumentException if <code>minNumDocs</code> is less than 2.
     * @see #minNumDocs
     */
    ...
    protected <T> Map<Resource, Double> getResourceScores(
        ...
        analysisData(cskTopN + maxShard*10 + 500);
