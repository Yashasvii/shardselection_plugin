...
public final class ScoredEntity<T> implements Comparable<ScoredEntity<T>> {
     ...
     * @throws NullPointerException if the <code>entity</code> is <code>null</code>.
     */
     ...
     * @throws NullPointerException if <code>scoredEntities</code> is <code>null</code>.
     */
    ...
    public int compareTo(ScoredEntity<T> scoredEntity) {
        ...
        double entityScore = scoredEntity.getScore();
