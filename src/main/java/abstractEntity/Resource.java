...
public final class Resource {
     ...
     * @throws NullPointerException     if the <code>resource</code> is <code>null</code>.
     * @throws IllegalArgumentException if the <code>fullSize</code> or <code>sampleSize</code>
